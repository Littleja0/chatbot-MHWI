...
## Background
The current RAG documents for armor sets are unstructured and often miss critical details like slots or clear skill levels for each piece. This leads to the chatbot being unable to accurately answer specific questions about build optimization.
