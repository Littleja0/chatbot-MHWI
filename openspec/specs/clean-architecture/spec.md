...
## Purpose
Define os padrões de organização e estrutura modular do projeto monorepo, incluindo a padronização de paths, limpeza de imports, centralização de ferramentas e servimento do frontend.
